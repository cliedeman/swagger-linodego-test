...
/* 
DomainsApiService Create Domain
Adds a new Domain to Linode&#x27;s DNS Manager. Linode is not a registrar, and you must own the domain before adding it here. Be sure to point your registrar to Linode&#x27;s nameservers so that the records hosted here are used. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the domain you are registering.
@return Domain
*/
func (a *DomainsApiService) CreateDomain(ctx context.Context, body Domain) (Domain, *http.Response, error) {
	var (
...
/* 
DomainsApiService Create Domain Record
Adds a new Domain Record to the zonefile this Domain represents. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about the new Record to add.

 * @param domainId The ID of the Domain we are accessing Records for.
@return DomainRecord
*/
func (a *DomainsApiService) CreateDomainRecord(ctx context.Context, body Object, domainId int32) (DomainRecord, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
DomainsApiService Delete Domain
...
@return interface{}
*/
func (a *DomainsApiService) DeleteDomain(ctx context.Context, domainId int32) (interface{}, *http.Response, error) {
	var (
...
/* 
DomainsApiService Delete Domain Record
...
@return interface{}
*/
func (a *DomainsApiService) DeleteDomainRecord(ctx context.Context, domainId int32, recordId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
DomainsApiService View Domain
This is a single Domain that you have registered in Linode&#x27;s DNS Manager. Linode is not a registrar, and in order for this Domain record to work you must own the domain and point your registrar at Linode&#x27;s nameservers. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param domainId The ID of the Domain to access.
@return Domain
*/
func (a *DomainsApiService) GetDomain(ctx context.Context, domainId int32) (Domain, *http.Response, error) {
	var (
...
/* 
DomainsApiService View Domain Record
...
@return DomainRecord
*/
func (a *DomainsApiService) GetDomainRecord(ctx context.Context, domainId int32, recordId int32) (DomainRecord, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
DomainsApiService List Domain Records
...
func (a *DomainsApiService) GetDomainRecords(ctx context.Context, domainId int32, localVarOptionals *GetDomainRecordsOpts) (InlineResponse2009, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *DomainsApiService) GetDomains(ctx context.Context, localVarOptionals *GetDomainsOpts) (InlineResponse2008, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
DomainsApiService Import a Domain Zone
...
@return Domain
*/
func (a *DomainsApiService) ImportDomain(ctx context.Context, ) (Domain, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
DomainsApiService Update Domain
Update information about a Domain in Linode&#x27;s DNS Manager. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The Domain information to update.
 * @param domainId The ID of the Domain to access.
@return Domain
*/
func (a *DomainsApiService) UpdateDomain(ctx context.Context, body Domain, domainId int32) (Domain, *http.Response, error) {
	var (
...
/* 
DomainsApiService Update Domain Record
Updates a single Record on this Domain. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The values to change.
 * @param domainId The ID of the Domain whose Record you are accessing.
 * @param recordId The ID of the Record you are accessing.
@return DomainRecord
*/
func (a *DomainsApiService) UpdateDomainRecord(ctx context.Context, body DomainRecord, domainId int32, recordId int32) (DomainRecord, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
