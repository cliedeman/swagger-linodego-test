...
/* 
ProfileApiService Add SSH Key
Adds an SSH Key to your Account profile. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return SshKey
*/
func (a *ProfileApiService) AddSSHKey(ctx context.Context, ) (SshKey, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(SshKeyRequest)
		if !localVarOptionalok {
				return localVarReturnValue, nil, reportError("body should be SshKeyRequest")
		}
...
/* 
ProfileApiService Create Personal Access Token
...
*/
func (a *ProfileApiService) CreatePersonalAccessToken(ctx context.Context, body Body19) (PersonalAccessToken, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService Revoke Personal Access Token
Revokes a Personal Access Token. The token will be invalidated immediately, and requests using that token will fail with a 401. It is possible to revoke access to the token making the request to revoke a token, but keep in mind that doing so could lose you access to the api and require you to create a new token through some other means. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tokenId The ID of the token to access.
@return interface{}
*/
func (a *ProfileApiService) DeletePersonalAccessToken(ctx context.Context, tokenId int32) (interface{}, *http.Response, error) {
	var (
...
/* 
ProfileApiService Revoke App Access
...
@return interface{}
*/
func (a *ProfileApiService) DeleteProfileApp(ctx context.Context, appId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService Delete SSH Key
...
@return interface{}
*/
func (a *ProfileApiService) DeleteSSHKey(ctx context.Context, sshKeyId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService View Personal Access Token
Returns a single Personal Access Token. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tokenId The ID of the token to access.
@return PersonalAccessToken
*/
func (a *ProfileApiService) GetPersonalAccessToken(ctx context.Context, tokenId int32) (PersonalAccessToken, *http.Response, error) {
	var (
...
/* 
ProfileApiService List Personal Access Tokens
Returns a paginated list of Personal Access Tokens currently active for your User. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse20033
*/
func (a *ProfileApiService) GetPersonalAccessTokens(ctx context.Context) (InlineResponse20033, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService View Profile
...
@return Profile
*/
func (a *ProfileApiService) GetProfile(ctx context.Context) (Profile, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService View Authorized App
Returns information about a single app you&#x27;ve authorized to access your Account. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param appId The authorized app ID to manage.
@return AuthorizedApp
*/
func (a *ProfileApiService) GetProfileApp(ctx context.Context, appId int32) (AuthorizedApp, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService List Authorized Apps
...
func (a *ProfileApiService) GetProfileApps(ctx context.Context, localVarOptionals *GetProfileAppsOpts) (InlineResponse20032, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ProfileApiService) GetProfileGrants(ctx context.Context) (GrantsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService View SSH Key
Returns a single SSH Key object identified by &#x60;id&#x60; that you have access to view. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sshKeyId The ID of the SSHKey
@return SshKey
*/
func (a *ProfileApiService) GetSSHKey(ctx context.Context, sshKeyId int32) (SshKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService List SSH Keys
...
func (a *ProfileApiService) GetSSHKeys(ctx context.Context, localVarOptionals *GetSSHKeysOpts) (InlineResponse20034, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService Confirm/Enable Two Factor Authentication
...
@return Object
*/
func (a *ProfileApiService) TfaConfirm(ctx context.Context, body Body18) (Object, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService Disable Two Factor Authentication
...
@return interface{}
*/
func (a *ProfileApiService) TfaDisable(ctx context.Context) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService Create Two Factor Secret
...
@return Object
*/
func (a *ProfileApiService) TfaEnable(ctx context.Context) (Object, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService Update Personal Access Token
...
@return PersonalAccessToken
*/
func (a *ProfileApiService) UpdatePersonalAccessToken(ctx context.Context, body PersonalAccessToken, tokenId int32) (PersonalAccessToken, *http.Response, error) {
	var (
...
/* 
ProfileApiService Update Profile
Update information in your Profile.  This endpoint requires the \&quot;account:read_write\&quot; OAuth Scope. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The fields to update.
@return Profile
*/
func (a *ProfileApiService) UpdateProfile(ctx context.Context, body Profile) (Profile, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ProfileApiService Update SSH Key
...
@return SshKey
*/
func (a *ProfileApiService) UpdateSSHKey(ctx context.Context, body SshKey, sshKeyId int32) (SshKey, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
