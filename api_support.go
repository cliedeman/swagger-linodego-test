...
/* 
SupportApiService Open Support Ticket
...
*/
func (a *SupportApiService) CreateTicket(ctx context.Context, ) (SupportTicket, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(SupportTicketRequest)
		if !localVarOptionalok {
				return localVarReturnValue, nil, reportError("body should be SupportTicketRequest")
		}
...
/* 
SupportApiService Create Ticket Attachment
...
@return interface{}
*/
func (a *SupportApiService) CreateTicketAttachment(ctx context.Context, ticketId int32, ) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
SupportApiService Create Reply
...
*/
func (a *SupportApiService) CreateTicketReply(ctx context.Context, body Body21, ticketId int32) (SupportTicketReply, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
SupportApiService View Support Ticket
Returns a Support Ticket under your Account. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ticketId The ID of the Support Ticket.
@return SupportTicket
*/
func (a *SupportApiService) GetTicket(ctx context.Context, ticketId int32) (SupportTicket, *http.Response, error) {
	var (
...
/* 
SupportApiService List Replies
...
func (a *SupportApiService) GetTicketReplies(ctx context.Context, ticketId int32, localVarOptionals *GetTicketRepliesOpts) (InlineResponse20037, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
SupportApiService List Support Tickets
...
func (a *SupportApiService) GetTickets(ctx context.Context, localVarOptionals *GetTicketsOpts) (InlineResponse20036, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
