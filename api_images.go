...
@return ImagePrivate
*/
func (a *ImagesApiService) CreateImage(ctx context.Context, ) (ImagePrivate, *http.Response, error) {
	var (
...
@return interface{}
*/
func (a *ImagesApiService) DeleteImage(ctx context.Context, imageId string) (interface{}, *http.Response, error) {
	var (
...
/* 
ImagesApiService View Image
Get information about a single Image. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param imageId ID of the Image to look up.
@return ImagePrivate
*/
func (a *ImagesApiService) GetImage(ctx context.Context, imageId string) (ImagePrivate, *http.Response, error) {
	var (
...
func (a *ImagesApiService) GetImages(ctx context.Context, localVarOptionals *GetImagesOpts) (InlineResponse20010, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ImagePrivate
*/
func (a *ImagesApiService) UpdateImage(ctx context.Context, body ImagePrivate, imageId string) (ImagePrivate, *http.Response, error) {
	var (
