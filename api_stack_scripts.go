 ...
 * @param body The properties to set for the new StackScript.
@return StackScript
*/
func (a *StackScriptsApiService) AddStackScript(ctx context.Context, body Object) (StackScript, *http.Response, error) {
	var (
...
@return interface{}
*/
func (a *StackScriptsApiService) DeleteStackScript(ctx context.Context, stackscriptId string) (interface{}, *http.Response, error) {
	var (
...
@return StackScript
*/
func (a *StackScriptsApiService) UpdateStackScript(ctx context.Context, stackscriptId string, ) (StackScript, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(StackScript)
		if !localVarOptionalok {
				return localVarReturnValue, nil, reportError("body should be StackScript")
		}
