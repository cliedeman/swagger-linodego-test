...
/* 
NodeBalancersApiService Create NodeBalancer
...
@return NodeBalancer
*/
func (a *NodeBalancersApiService) CreateNodeBalancer(ctx context.Context, body Body17) (NodeBalancer, *http.Response, error) {
	var (
...
/* 
NodeBalancersApiService Create Config
...
*/
func (a *NodeBalancersApiService) CreateNodeBalancerConfig(ctx context.Context, nodeBalancerId int32, ) (NodeBalancerConfig, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	localVarPath = strings.Replace(localVarPath, "{"+"nodeBalancerId"+"}", fmt.Sprintf("%v", nodeBalancerId), -1)
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(NodeBalancerConfig)
		if !localVarOptionalok {
				return localVarReturnValue, nil, reportError("body should be NodeBalancerConfig")
		}
...
/* 
NodeBalancersApiService Create Node
...
*/
func (a *NodeBalancersApiService) CreateNodeBalancerNode(ctx context.Context, body Object, nodeBalancerId int32, configId int32) (NodeBalancerNode, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService Delete NodeBalancer
...
@return interface{}
*/
func (a *NodeBalancersApiService) DeleteNodeBalancer(ctx context.Context, nodeBalancerId int32) (interface{}, *http.Response, error) {
	var (
...
/* 
NodeBalancersApiService Delete Config
...
@return interface{}
*/
func (a *NodeBalancersApiService) DeleteNodeBalancerConfig(ctx context.Context, nodeBalancerId int32, configId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService Delete Node
...
@return interface{}
*/
func (a *NodeBalancersApiService) DeleteNodeBalancerConfigNode(ctx context.Context, nodeBalancerId int32, configId int32, nodeId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService View NodeBalancer
Returns a single NodeBalancer you can access. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param nodeBalancerId The ID of the NodeBalancer to access.
@return NodeBalancer
*/
func (a *NodeBalancersApiService) GetNodeBalancer(ctx context.Context, nodeBalancerId int32) (NodeBalancer, *http.Response, error) {
	var (
...
/* 
NodeBalancersApiService View Config
...
@return NodeBalancerConfig
*/
func (a *NodeBalancersApiService) GetNodeBalancerConfig(ctx context.Context, nodeBalancerId int32, configId int32) (NodeBalancerConfig, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService List Nodes
...
func (a *NodeBalancersApiService) GetNodeBalancerConfigNodes(ctx context.Context, nodeBalancerId int32, configId int32, localVarOptionals *GetNodeBalancerConfigNodesOpts) (InlineResponse20031, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService List Configs
...
func (a *NodeBalancersApiService) GetNodeBalancerConfigs(ctx context.Context, nodeBalancerId int32, localVarOptionals *GetNodeBalancerConfigsOpts) (InlineResponse20030, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService View Node
...
@return NodeBalancerNode
*/
func (a *NodeBalancersApiService) GetNodeBalancerNode(ctx context.Context, nodeBalancerId int32, configId int32, nodeId int32) (NodeBalancerNode, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService List NodeBalancers
...
func (a *NodeBalancersApiService) GetNodeBalancers(ctx context.Context, localVarOptionals *GetNodeBalancersOpts) (InlineResponse20029, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService View NodeBalancer Statistics
Returns detailed statistics about the requested NodeBalancer. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param nodeBalancerId The ID of the NodeBalancer to access.
@return NodeBalancerStats
*/
func (a *NodeBalancersApiService) NodebalancersNodeBalancerIdStatsGet(ctx context.Context, nodeBalancerId int32) (NodeBalancerStats, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService Update NodeBalancer
...
@return NodeBalancer
*/
func (a *NodeBalancersApiService) UpdateNodeBalancer(ctx context.Context, body NodeBalancer, nodeBalancerId int32) (NodeBalancer, *http.Response, error) {
	var (
...
/* 
NodeBalancersApiService Update Config
...
@return NodeBalancerConfig
*/
func (a *NodeBalancersApiService) UpdateNodeBalancerConfig(ctx context.Context, body NodeBalancerConfig, nodeBalancerId int32, configId int32) (NodeBalancerConfig, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
NodeBalancersApiService Update Node
...
@return NodeBalancerNode
*/
func (a *NodeBalancersApiService) UpdateNodeBalancerNode(ctx context.Context, body NodeBalancerNode, nodeBalancerId int32, configId int32, nodeId int32) (NodeBalancerNode, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
