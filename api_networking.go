...
/*
NetworkingApiService Allocate IP Address
...
@return IpAddress
*/
func (a *NetworkingApiService) AllocateIP(ctx context.Context, body Body14) (IpAddress, *http.Response, error) {
	var (
...
/*
NetworkingApiService Assign IPs to Linodes
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about what IPv4 address to assign, and to which Linode.

@return interface{}
*/
func (a *NetworkingApiService) AssignIPs(ctx context.Context, body Body15) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
NetworkingApiService View IP Address
Returns information about a single IP Address on your Account.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param address The address to operate on.
@return IpAddress
*/
func (a *NetworkingApiService) GetIP(ctx context.Context, address string) (IpAddress, *http.Response, error) {
	var (
...
/*
NetworkingApiService List IP Addresses
Returns a paginated list of IP Addresses on your Account, excluding private addresses.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return InlineResponse20026
*/
func (a *NetworkingApiService) GetIPs(ctx context.Context) (InlineResponse20026, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
NetworkingApiService List IPv6 Pools
...
func (a *NetworkingApiService) GetIPv6Pools(ctx context.Context, localVarOptionals *GetIPv6PoolsOpts) (InlineResponse20027, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
NetworkingApiService List IPv6 Ranges
...
func (a *NetworkingApiService) GetIPv6Ranges(ctx context.Context, localVarOptionals *GetIPv6RangesOpts) (InlineResponse20028, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
NetworkingApiService Configure IP Sharing
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Information about what IPs to share with which Linode.
@return interface{}
*/
func (a *NetworkingApiService) ShareIPs(ctx context.Context, body Body16) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
NetworkingApiService Update IP Address RDNS
...
@return IpAddress
*/
func (a *NetworkingApiService) UpdateIP(ctx context.Context, body IpAddress, address string) (IpAddress, *http.Response, error) {
	var (
