...
@return OAuthClient
*/
func (a *AccountApiService) CreateClient(ctx context.Context, ) (OAuthClient, *http.Response, error) {
	var (
...
@return interface{}
*/
func (a *AccountApiService) CreateCreditCard(ctx context.Context, body CreditCard) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *AccountApiService) CreatePayPalPayment(ctx context.Context, body PayPal) (InlineResponse2006, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return Payment
*/
func (a *AccountApiService) CreatePayment(ctx context.Context, body PaymentRequest) (Payment, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return User
*/
func (a *AccountApiService) CreateUser(ctx context.Context, ) (User, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(Body)
		if !localVarOptionalok {
...
@return interface{}
*/
func (a *AccountApiService) DeleteClient(ctx context.Context, clientId string) (interface{}, *http.Response, error) {
	var (
...
@return interface{}
*/
func (a *AccountApiService) DeleteUser(ctx context.Context, username string) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *AccountApiService) EventRead(ctx context.Context, eventId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *AccountApiService) EventSeen(ctx context.Context, eventId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *AccountApiService) ExecutePayPalPayment(ctx context.Context, body PayPalExecute) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return string
*/
func (a *AccountApiService) GetClientThumbnail(ctx context.Context, clientId string) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return interface{}
*/
func (a *AccountApiService) SetClientThumbnail(ctx context.Context, body Object, clientId string) (interface{}, *http.Response, error) {
	var (
...
@return Account
*/
func (a *AccountApiService) UpdateAccount(ctx context.Context, body Account) (Account, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return AccountSettings
*/
func (a *AccountApiService) UpdateAccountSettings(ctx context.Context, body AccountSettings) (AccountSettings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return OAuthClient
*/
func (a *AccountApiService) UpdateClient(ctx context.Context, clientId string, ) (OAuthClient, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(OAuthClient)
		if !localVarOptionalok {
...
@return User
*/
func (a *AccountApiService) UpdateUser(ctx context.Context, username string, ) (User, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(User)
		if !localVarOptionalok {
...
@return GrantsResponse
*/
func (a *AccountApiService) UpdateUserGrants(ctx context.Context, body GrantsResponse, username string) (GrantsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
