...
/* 
ManagedApiService Create Managed Contact
...
*/
func (a *ManagedApiService) CreateManagedContact(ctx context.Context, ) (ManagedContact, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(ManagedContact)
		if !localVarOptionalok {
				return localVarReturnValue, nil, reportError("body should be ManagedContact")
		}
...
/* 
ManagedApiService Create Managed Credential
...
*/
func (a *ManagedApiService) CreateManagedCredential(ctx context.Context, ) (ManagedCredential, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals..IsSet() {
		...
		localVarOptional, localVarOptionalok := localVarOptionals..Value().(Object)
		if !localVarOptionalok {
...
/* 
ManagedApiService Create Managed Service
...
*/
func (a *ManagedApiService) CreateManagedService(ctx context.Context, ) (ManagedService, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService Delete Managed Contact
Deletes a Managed Contact. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contactId The ID of the contact to access.
@return interface{}
*/
func (a *ManagedApiService) DeleteManagedContact(ctx context.Context, contactId int32) (interface{}, *http.Response, error) {
	var (
...
/* 
ManagedApiService Delete Managed Credential
...
@return interface{}
*/
func (a *ManagedApiService) DeleteManagedCredential(ctx context.Context, credentialId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService Delete Managed Service
...
@return interface{}
*/
func (a *ManagedApiService) DeleteManagedService(ctx context.Context, serviceId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService Disable Managed Service
Temporarily disables monitoring of a Managed Service. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId The ID of the Managed Service to disable.
@return ManagedService
*/
func (a *ManagedApiService) DisableManagedService(ctx context.Context, serviceId int32) (ManagedService, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService Enable Managed Service
Enables monitoring of a Managed Service. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId The ID of the Managed Service to enable.
@return ManagedService
*/
func (a *ManagedApiService) EnableManagedService(ctx context.Context, serviceId int32) (ManagedService, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService View Managed Contact
Returns a single Managed Contact. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contactId The ID of the contact to access.
@return ManagedContact
*/
func (a *ManagedApiService) GetManagedContact(ctx context.Context, contactId int32) (ManagedContact, *http.Response, error) {
	var (
...
/* 
ManagedApiService List Managed Contacts
...
func (a *ManagedApiService) GetManagedContacts(ctx context.Context, localVarOptionals *GetManagedContactsOpts) (InlineResponse20021, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService View Managed Credential
Returns a single Managed Credential. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param credentialId The ID of the Credential to access.
@return ManagedCredential
*/
func (a *ManagedApiService) GetManagedCredential(ctx context.Context, credentialId int32) (ManagedCredential, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService List Managed Credentials
...
func (a *ManagedApiService) GetManagedCredentials(ctx context.Context, localVarOptionals *GetManagedCredentialsOpts) (InlineResponse20022, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService View Managed Issue
Returns a single Issue that is impacting or did impact one of your Managed Services. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param issueId The Issue to look up.
@return ManagedIssue
*/
func (a *ManagedApiService) GetManagedIssue(ctx context.Context, issueId int32) (ManagedIssue, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService List Managed Issues
...
func (a *ManagedApiService) GetManagedIssues(ctx context.Context, localVarOptionals *GetManagedIssuesOpts) (InlineResponse20023, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService View Linode&#x27;s Managed Settings
Returns a single Linode&#x27;s Managed settings. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param linodeId The Linode ID whose settings we are accessing.
@return ManagedLinodeSettings
*/
func (a *ManagedApiService) GetManagedLinodeSetting(ctx context.Context, linodeId int32) (ManagedLinodeSettings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService List Managed Linode Settings
...
func (a *ManagedApiService) GetManagedLinodeSettings(ctx context.Context, localVarOptionals *GetManagedLinodeSettingsOpts) (InlineResponse20024, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService View Managed Service
Returns information about a single Managed Service on your Account. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId The ID of the Managed Service to access.
@return ManagedService
*/
func (a *ManagedApiService) GetManagedService(ctx context.Context, serviceId int32) (ManagedService, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService List Managed Services
...
*/
func (a *ManagedApiService) GetManagedServices(ctx context.Context) (InlineResponse20025, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService Update Managed Contact
...
@return ManagedContact
*/
func (a *ManagedApiService) UpdateManagedContact(ctx context.Context, body ManagedContact, contactId int32) (ManagedContact, *http.Response, error) {
	var (
...
/* 
ManagedApiService Update Managed Credential
...
@return ManagedCredential
*/
func (a *ManagedApiService) UpdateManagedCredential(ctx context.Context, body ManagedCredential, credentialId int32) (ManagedCredential, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService Update Linode&#x27;s Managed Settings
...
@return ManagedLinodeSettings
*/
func (a *ManagedApiService) UpdateManagedLinodeSetting(ctx context.Context, body ManagedLinodeSettings, linodeId int32) (ManagedLinodeSettings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
ManagedApiService Update Managed Service
...
@return ManagedService
*/
func (a *ManagedApiService) UpdateManagedService(ctx context.Context, body ManagedService, serviceId int32) (ManagedService, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
