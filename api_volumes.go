...
/*
VolumesApiService Attach Volume
 ...
 * @param body Volume to attach to a Linode.
 * @param volumeId ID of the Volume to attach.
@return Volume
*/
func (a *VolumesApiService) AttachVolume(ctx context.Context, body Body23, volumeId int32) (Volume, *http.Response, error) {
	var (
...
/*
VolumesApiService Clone Volume
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The requested state your Volume will be cloned into.
 * @param volumeId ID of the Volume to clone.
@return interface{}
*/
func (a *VolumesApiService) CloneVolume(ctx context.Context, body Body24, volumeId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
VolumesApiService Create Volume
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The requested initial state of a new Volume.
@return Volume
*/
func (a *VolumesApiService) CreateVolume(ctx context.Context, body Body22) (Volume, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
VolumesApiService Delete Volume
...
@return interface{}
*/
func (a *VolumesApiService) DeleteVolume(ctx context.Context, volumeId int32) (interface{}, *http.Response, error) {
	var (
...
/*
VolumesApiService Detach Volume
...
@return interface{}
*/
func (a *VolumesApiService) DetachVolume(ctx context.Context, volumeId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *VolumesApiService) GetVolume(ctx context.Context, volumeId int32, localVarOptionals *GetVolumeOpts) (Volume, *http.Response, error) {
	var (
...
func (a *VolumesApiService) GetVolumes(ctx context.Context, localVarOptionals *GetVolumesOpts) (InlineResponse20016, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
VolumesApiService Resize Volume
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The requested size to increase your Volume to.
 * @param volumeId ID of the Volume to resize.
@return interface{}
*/
func (a *VolumesApiService) ResizeVolume(ctx context.Context, body Body25, volumeId int32) (interface{}, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
VolumesApiService Update Volume
Updates a Volume that you have permission to &#x60;read_write&#x60;.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body If any updated field fails to pass validation, the Volume will not be updated.

 * @param volumeId ID of the Volume to look up.
@return Volume
*/
func (a *VolumesApiService) UpdateVolume(ctx context.Context, body Object, volumeId int32) (Volume, *http.Response, error) {
	var (
