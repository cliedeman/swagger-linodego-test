...
/*
LongviewApiService Create Longview Client
...
*/
func (a *LongviewApiService) CreateLongviewClient(ctx context.Context, body LongviewClient) (LongviewClient, *http.Response, error) {
	var (
...
/*
LongviewApiService Delete Longview Client
...
@return interface{}
*/
func (a *LongviewApiService) DeleteLongviewClient(ctx context.Context, clientId int32) (interface{}, *http.Response, error) {
	var (
...
/*
LongviewApiService View Longview Client
Returns a single Longview Client you can access.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clientId The Longview Client ID to access.
@return LongviewClient
*/
func (a *LongviewApiService) GetLongviewClient(ctx context.Context, clientId int32) (LongviewClient, *http.Response, error) {
	var (
...
/*
LongviewApiService List Longview Clients
...
func (a *LongviewApiService) GetLongviewClients(ctx context.Context, localVarOptionals *GetLongviewClientsOpts) (InlineResponse20019, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
LongviewApiService View Longview Subscription
...
*/
func (a *LongviewApiService) GetLongviewSubscription(ctx context.Context, subscriptionId string) (LongviewSubscription, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
LongviewApiService List Longview Subscriptions
...
func (a *LongviewApiService) GetLongviewSubscriptions(ctx context.Context, localVarOptionals *GetLongviewSubscriptionsOpts) (InlineResponse20020, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
LongviewApiService Update Longview Client
...
@return LongviewClient
*/
func (a *LongviewApiService) UpdateLongviewClient(ctx context.Context, body LongviewClient, clientId int32) (LongviewClient, *http.Response, error) {
	var (
